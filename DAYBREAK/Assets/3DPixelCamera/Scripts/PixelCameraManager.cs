namespace PixelCamera
{
    ...
    public class PixelCameraManager : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            {
                this.viewCamera = FindObjectOfType(typeof(CanvasViewCamera)) as CanvasViewCamera;
                if (this.viewCamera == null)
                {
            ...
            {
                this.upscaledCanvas = FindObjectOfType(typeof(UpscaledCanvas)) as UpscaledCanvas;
                if (this.upscaledCanvas == null)
                {
